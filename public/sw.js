// Minimal service worker for AiravatL Enterprise.
...
// briefly drops. It is intentionally network-first — the portal is always-online
// and must never serve stale data.
const CACHE = "airavatl-enterprise-v1";
