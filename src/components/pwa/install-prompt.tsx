...
const DISMISS_KEY = "enterprise-install-dismissed";
...
/**
 * Mobile-only top banner prompting the user to install the portal to their home
  ...
  return (
    <div className="flex items-center gap-3 border-b border-violet-200 bg-violet-50 px-3 py-2 md:hidden">
      ...
      <div className="min-w-0 flex-1">
        <p className="truncate text-xs font-semibold text-violet-900">Install AiravatL Enterprise</p>
        {ios ? (
          <p className="flex items-center gap-1 truncate text-[11px] text-violet-700">
            Tap <Share className="inline h-3 w-3" /> then &ldquo;Add to Home Screen&rdquo;
          </p>
        ) : (
